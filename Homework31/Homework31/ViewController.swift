...
// ნილს გავუტოლებთ, job-ს აღარ ექნება მასთან strong კავშირი და იგი ამოიშლება მეხსიერებიდან (შესაბამისად 
// დაიპრინტება მისი deinit-ის ტექსტი). შემდეგ developer-იც უტოლდება ნილს და რადგან person-თან კავშირი 
// აღარ გვაქვს, ისიც წაიშლება მეხსიერებიდან და დაიპრინტება მისი deinit-ის ტექსტი.
